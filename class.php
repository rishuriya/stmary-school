...
<div class="main">
    ...
    $id = $_GET['id'];
	$sql="select class from class where id='$id'";
...
?>
	       	     <div class="style2"> 
	       	       <div align="center"><?php echo $row1['class'];?></div>
	       	     </div>     
	    </div>
    </div>
</div>
    ...
    if(mysqli_num_rows($query_run)>0)
          {
            while($row= mysqli_fetch_assoc($query_run))
              { 
                ...
                ?>
<button class="button"><a href="chapter.php?id=<?php echo $row['id'];?>"><?php echo $row['subject'];?></a> </button>
<?php
